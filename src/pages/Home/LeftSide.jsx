    ...
    <>
      <div className='w-full flex flex-col gap-4 justify-center sm:items-start items-center sm:order-0 order-1 sm:ps-16'>
        ...
        <p className='text-sm opacity-50 text-center sm:text-left'>
          Passionate about crafting beautiful and functional web applications. With expertise in
          JavaScript, React, and modern CSS, I enjoy building user-friendly interfaces that enhance
          user experience. Let's collaborate and create something amazing together!
        </p>
        <Button
          onClick={() => {
